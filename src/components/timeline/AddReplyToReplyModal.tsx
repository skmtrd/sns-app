...
export const AddReplyToReplyModal: React.FC<AddPostProps> = ({
  closeModal,
  parentReplyId,
  postId,
}) => {
  ...
  const onSubmit: SubmitHandler<FormInputs> = async (data) => {
    ...
    try {
      const response = await fetch(`/api/post/${postId}/reply/${parentReplyId}/reply`, {
        method: 'POST',
        headers: {
  ...
  return (
    <div
      ...
      className='animate-fadeIn fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4'
    >
      <div
